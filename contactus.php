...
<html>
  ...
  <head>
    <title> Contact | BRUR_Cafeteria </title>
  </head>
...
?>
    ...
    <div class="heading">
     <strong>Want to contact <span class="edit"> BRUR_Cafeteria</span>?</strong>
     <br>
    ...
    <div class="col-md-5" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          <h3 style="font-family:Bradley Hand, cursive;" style="margin-bottom: 25px; text-align: center; font-size: 30px;"> Contact Form</h3>
