...
<html>
  ...
  <head>
    <title> Home | BRUR-Cafeteria </title>
  </head>
...
?>
    ...
    <div class="">
        ...
        <div class="col-xs-2 logo"><img src="images/logo.png" style="width: 120px"></div>
        <div class="col-xs-5 line"><hr></div>
        <div class="tagline"> 
        <h1 style="font-family:Bradley Hand, cursive; color: red; margin-bottom: 25px; text-align: center; font-size: 50px;"> Good Food is Good Mood </h1>
