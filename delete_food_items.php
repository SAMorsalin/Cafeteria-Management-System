...
<html>
  ...
  <head>
    <title> Manager Login | BRUR_Cafeteria </title>
  </head>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse " id="myNavbar">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a href="#"><span class=""></span> Hi <?php echo $login_session; ?> </a></li>
...
<div class="container">
    <div class="jumbotron">
     <h1>Hi <?php echo $login_session; ?>! </a></li> </h1>
...
<div class="container">
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="font-family:Bradley Hand, cursive;" style="margin-bottom: 25px; text-align: center; font-size: 30px;"> DELETE YOUR FOOD ITEMS FROM HERE </h3>
