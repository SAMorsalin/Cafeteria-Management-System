...
<html>
  ...
  <head>
    <title> Explore | BRUR_Cafeteria </title>
  </head>
...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            <li><a href="#"><span class=""></span> Hi <?php echo $_SESSION['login_user2']; ?> </a></li>
            <li class="active" ><a href="foodlist.php"><span class=""></span> Food Zone </a></li>
            <li><a href="cart.php"><span class=""></span> Cart  (<?php
...
<div class="jumbotron">
  <div class="container text-center">
    <p style="font-family:Bradley Hand, cursive; font-size: 40px;">
      Welcome To BRUR Cafeteria
    </p>
    <h1></h1>      
